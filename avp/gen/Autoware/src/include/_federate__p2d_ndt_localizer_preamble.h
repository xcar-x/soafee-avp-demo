...
do { \
    ...
    _lf_action_table[0] = (lf_action_base_t*)&_ocalizer_nr_federate__p2d_ndt_localizer_self[0]->_lf_networkMessage; \
    _ocalizer_nr_federate__p2d_ndt_localizer_self[0]->_lf_networkMessage.source_id = 4; \
    _lf_action_delay_table[1] = 250000000; \
    _lf_action_table[1] = (lf_action_base_t*)&_alizer_nr_federate__p2d_ndt_localizer_0_self[0]->_lf_networkMessage; \
    _alizer_nr_federate__p2d_ndt_localizer_0_self[0]->_lf_networkMessage.source_id = 7; \
    staa_initialization(); \
} \
while (0)
/**
