...
do { \
    ...
    _lf_action_table[0] = (lf_action_base_t*)&_fier_nr_federate__ray_ground_classifier_self[0]->_lf_networkMessage; \
    _fier_nr_federate__ray_ground_classifier_self[0]->_lf_networkMessage.source_id = 3; \
    staa_initialization(); \
} \
while (0)
/**
