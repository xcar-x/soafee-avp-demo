...
do { \
    _lf_action_delay_table[0] = 150000000; \
    _lf_action_table[0] = (lf_action_base_t*)&_nr_federate__object_collision_estimator_self[0]->_lf_networkMessage; \
    _nr_federate__object_collision_estimator_self[0]->_lf_networkMessage.source_id = 9; \
    _lf_action_delay_table[1] = NEVER; \
    _lf_action_table[1] = (lf_action_base_t*)&__federate__object_collision_estimator_0_self[0]->_lf_networkMessage; \
    __federate__object_collision_estimator_0_self[0]->_lf_networkMessage.source_id = 10; \
    staa_initialization(); \
} \
while (0)
/**
