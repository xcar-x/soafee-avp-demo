...
void _lf_executable_preamble(environment_t* env) {
    ...
    lf_connect_to_federate(4);
    lf_connect_to_federate(5);
}
...
do { \
    ...
    _lf_action_table[0] = (lf_action_base_t*)&__fusion_nr_federate__point_cloud_fusion_self[0]->_lf_networkMessage; \
    __fusion_nr_federate__point_cloud_fusion_self[0]->_lf_networkMessage.source_id = 1; \
    _lf_action_delay_table[1] = NEVER; \
    _lf_action_table[1] = (lf_action_base_t*)&_usion_nr_federate__point_cloud_fusion_0_self[0]->_lf_networkMessage; \
    _usion_nr_federate__point_cloud_fusion_0_self[0]->_lf_networkMessage.source_id = 2; \
    staa_initialization(); \
} \
while (0)
/**
