...
void _lf_executable_preamble(environment_t* env) {
    ...
    _fed.number_of_outbound_p2p_connections = 2;
...
do { \
    ...
    _lf_action_table[0] = (lf_action_base_t*)&_r_nr_federate__off_map_obstacles_filter_self[0]->_lf_networkMessage; \
    _r_nr_federate__off_map_obstacles_filter_self[0]->_lf_networkMessage.source_id = 6; \
    _lf_action_delay_table[1] = NEVER; \
    _lf_action_table[1] = (lf_action_base_t*)&_nr_federate__off_map_obstacles_filter_0_self[0]->_lf_networkMessage; \
    _nr_federate__off_map_obstacles_filter_0_self[0]->_lf_networkMessage.source_id = 18; \
    staa_initialization(); \
} \
while (0)
/**
