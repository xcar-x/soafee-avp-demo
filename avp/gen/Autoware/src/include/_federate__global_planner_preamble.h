...
do { \
    ...
    _lf_action_table[0] = (lf_action_base_t*)&_bal_planner_nr_federate__global_planner_self[0]->_lf_networkMessage; \
    _bal_planner_nr_federate__global_planner_self[0]->_lf_networkMessage.source_id = 15; \
    _lf_action_delay_table[1] = NEVER; \
    _lf_action_table[1] = (lf_action_base_t*)&_l_planner_nr_federate__global_planner_0_self[0]->_lf_networkMessage; \
    _l_planner_nr_federate__global_planner_0_self[0]->_lf_networkMessage.source_id = 18; \
    staa_initialization(); \
} \
while (0)
/**
