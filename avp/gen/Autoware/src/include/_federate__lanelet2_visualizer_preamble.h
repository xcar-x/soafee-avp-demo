...
void _lf_executable_preamble(environment_t* env) {
    ...
    _lf_my_fed_id = 0;
    _fed.number_of_inbound_p2p_connections = 1;
...
do { \
    ...
    _lf_action_table[0] = (lf_action_base_t*)&_alizer_nr_federate__lanelet2_visualizer_self[0]->_lf_networkMessage; \
    _alizer_nr_federate__lanelet2_visualizer_self[0]->_lf_networkMessage.source_id = 18; \
    staa_initialization(); \
} \
while (0)
/**
