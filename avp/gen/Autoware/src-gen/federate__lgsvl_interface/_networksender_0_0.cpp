...
#include "include/federate__lgsvl_interface/NetworkSender_0_0.h"
...
void _networksender_0_0reaction_function_0(void* instance_args) {
    ...
    #line 121 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src/federate__lgsvl_interface.lf"
    // Sending from msg[0] in federate federate__lgsvl_interface to mpc_controller.vehicle_kinematic_state in federate federate__mpc_controller
    if (!msg[0]->is_present) {
    return;
    }
    ...
    lf_send_tagged_message(self->base.environment, 16000000, MSG_TYPE_P2P_TAGGED_MESSAGE, 1, 16, "federate 16", _lf_message_length, serialized_message.get_rcl_serialized_message().buffer);
#line 30 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src-gen/federate__lgsvl_interface/_networksender_0_0.cpp"
}
