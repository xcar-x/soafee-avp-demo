...
#include "include/federate__lgsvl_interface/NetworkSender_2_2.h"
...
void _networksender_2_2reaction_function_0(void* instance_args) {
    ...
    #line 155 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src/federate__lgsvl_interface.lf"
    // Sending from msg[0] in federate federate__lgsvl_interface to behavior_planner.vehicle_state_report in federate federate__behavior_planner
    if (!msg[0]->is_present) {
    return;
    }
    ...
    lf_send_tagged_message(self->base.environment, 1000000, MSG_TYPE_P2P_TAGGED_MESSAGE, 5, 10, "federate 10", _lf_message_length, serialized_message.get_rcl_serialized_message().buffer);
#line 30 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src-gen/federate__lgsvl_interface/_networksender_2_2.cpp"
}
...
_networksender_2_2_self_t* new__networksender_2_2() {
    ...
    #endif // FEDERATED
    self->_lf__msg.tmplt.type.element_size = sizeof(std::shared_ptr<autoware_auto_msgs::msg::VehicleStateReport>);
    return self;
}
