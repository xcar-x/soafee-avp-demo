...
#include "include/federate__lgsvl_interface/NetworkSender_1_1.h"
...
void _networksender_1_1reaction_function_0(void* instance_args) {
    ...
    #line 138 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src/federate__lgsvl_interface.lf"
    // Sending from msg[0] in federate federate__lgsvl_interface to behavior_planner.vehicle_kinematic_state in federate federate__behavior_planner
    if (!msg[0]->is_present) {
    return;
    }
    ...
    lf_send_tagged_message(self->base.environment, 1000000, MSG_TYPE_P2P_TAGGED_MESSAGE, 4, 10, "federate 10", _lf_message_length, serialized_message.get_rcl_serialized_message().buffer);
#line 30 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src-gen/federate__lgsvl_interface/_networksender_1_1.cpp"
}
...
_networksender_1_1_self_t* new__networksender_1_1() {
    ...
    #endif // FEDERATED
    self->_lf__msg.tmplt.type.element_size = sizeof(std::shared_ptr<autoware_auto_msgs::msg::VehicleKinematicState>);
    return self;
}
