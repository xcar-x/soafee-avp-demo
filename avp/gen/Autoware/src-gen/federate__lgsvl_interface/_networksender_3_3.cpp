...
#include "include/federate__lgsvl_interface/NetworkSender_3_3.h"
...
void _networksender_3_3reaction_function_0(void* instance_args) {
    ...
    #line 172 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src/federate__lgsvl_interface.lf"
    // Sending from msg[0] in federate federate__lgsvl_interface to global_planner.vehicle_kinematic_state in federate federate__global_planner
    if (!msg[0]->is_present) {
    return;
    }
    ...
    lf_send_tagged_message(self->base.environment, NEVER, MSG_TYPE_P2P_TAGGED_MESSAGE, 0, 13, "federate 13", _lf_message_length, serialized_message.get_rcl_serialized_message().buffer);
#line 30 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src-gen/federate__lgsvl_interface/_networksender_3_3.cpp"
}
