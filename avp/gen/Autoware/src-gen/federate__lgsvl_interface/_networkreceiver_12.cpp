...
#include "include/federate__lgsvl_interface/NetworkReceiver_12.h"
#include "_networkreceiver_12.h"
// ***** Start of method declarations.
// ***** End of method declarations.
#include "include/api/reaction_macros.h"
void _networkreceiver_12reaction_function_0(void* instance_args) {
    _networkreceiver_12_self_t* self = (_networkreceiver_12_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    
    #line 94 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src/federate__lgsvl_interface.lf"
    self->_lf__reaction_1.is_an_input_reaction = true;
#line 16 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src-gen/federate__lgsvl_interface/_networkreceiver_12.cpp"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _networkreceiver_12reaction_function_1(void* instance_args) {
    _networkreceiver_12_self_t* self = (_networkreceiver_12_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    lf_critical_section_enter(self->base.environment);
    // Expose the action struct as a local variable whose name matches the action name.
    _networkreceiver_12_networkMessage_t* networkMessage = &self->_lf_networkMessage;
    ...
    _networkreceiver_12_msg_t* msg = &self->_lf_msg;
    #line 98 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src/federate__lgsvl_interface.lf"
    ...
    using MessageT = autoware_auto_msgs::msg::VehicleStateCommand;
    ...
    auto msg_shared_ptr = std::make_shared<autoware_auto_msgs::msg::VehicleStateCommand>(deserialized_message);
    lf_set(msg, msg_shared_ptr);
#line 52 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src-gen/federate__lgsvl_interface/_networkreceiver_12.cpp"
}
#include "include/api/reaction_macros_undef.h"
_networkreceiver_12_self_t* new__networkreceiver_12() {
    _networkreceiver_12_self_t* self = (_networkreceiver_12_self_t*)lf_new_reactor(sizeof(_networkreceiver_12_self_t));
    ...
    self->_lf__reaction_0.function = _networkreceiver_12reaction_function_0;
    ...
    self->_lf__reaction_1.function = _networkreceiver_12reaction_function_1;
