...
#include "include/federate__euclidean_cluster_detector/_euclidean_cluster_detectorpoints_in.h"
...
__euclidean_cluster_detectorpoints_in_self_t* new___euclidean_cluster_detectorpoints_in() {
    __euclidean_cluster_detectorpoints_in_self_t* self = (__euclidean_cluster_detectorpoints_in_self_t*)lf_new_reactor(sizeof(__euclidean_cluster_detectorpoints_in_self_t));
