...
do { \
    ...
    _lf_action_table[0] = (lf_action_base_t*)&_nr_federate__euclidean_cluster_detector_self[0]->_lf_networkMessage; \
    _nr_federate__euclidean_cluster_detector_self[0]->_lf_networkMessage.source_id = 5; \
    staa_initialization(); \
} \
while (0)
/**
