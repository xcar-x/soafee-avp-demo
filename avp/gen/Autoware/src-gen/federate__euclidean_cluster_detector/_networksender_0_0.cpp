...
#include "include/federate__euclidean_cluster_detector/NetworkSender_0_0.h"
...
void _networksender_0_0reaction_function_0(void* instance_args) {
    ...
    #line 113 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src/federate__euclidean_cluster_detector.lf"
    // Sending from msg[0] in federate federate__euclidean_cluster_detector to off_map_obstacles_filter.original_bounding_boxes in federate federate__off_map_obstacles_filter
    if (!msg[0]->is_present) {
    return;
    }
    ...
    lf_send_tagged_message(self->base.environment, NEVER, MSG_TYPE_P2P_TAGGED_MESSAGE, 0, 9, "federate 9", _lf_message_length, serialized_message.get_rcl_serialized_message().buffer);
#line 30 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src-gen/federate__euclidean_cluster_detector/_networksender_0_0.cpp"
}
