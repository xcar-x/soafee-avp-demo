...
#include "include/federate__filter_and_transform__1/NetworkSender_0_0.h"
...
void _networksender_0_0reaction_function_0(void* instance_args) {
    ...
    #line 79 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src/federate__filter_and_transform__1.lf"
    // Sending from msg[0] in federate federate__filter_and_transform__1 to point_cloud_fusion.points_in in federate federate__point_cloud_fusion
    if (!msg[0]->is_present) {
    return;
    }
    ...
    lf_send_tagged_message(self->base.environment, NEVER, MSG_TYPE_P2P_TAGGED_MESSAGE, 1, 3, "federate 3", _lf_message_length, serialized_message.get_rcl_serialized_message().buffer);
#line 30 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src-gen/federate__filter_and_transform__1/_networksender_0_0.cpp"
}
