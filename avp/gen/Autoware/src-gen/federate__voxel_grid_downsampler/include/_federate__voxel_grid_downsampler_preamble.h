...
do { \
    ...
    _lf_action_table[0] = (lf_action_base_t*)&_ler_nr_federate__voxel_grid_downsampler_self[0]->_lf_networkMessage; \
    _ler_nr_federate__voxel_grid_downsampler_self[0]->_lf_networkMessage.source_id = 3; \
    staa_initialization(); \
} \
while (0)
/**
