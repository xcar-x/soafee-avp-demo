...
#include "include/federate__voxel_grid_downsampler/NetworkSender_0_0.h"
...
void _networksender_0_0reaction_function_0(void* instance_args) {
    ...
    #line 113 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src/federate__voxel_grid_downsampler.lf"
    // Sending from msg[0] in federate federate__voxel_grid_downsampler to p2d_ndt_localizer.fused_downsampled_points_in in federate federate__p2d_ndt_localizer
    if (!msg[0]->is_present) {
    return;
    }
    ...
    lf_send_tagged_message(self->base.environment, NEVER, MSG_TYPE_P2P_TAGGED_MESSAGE, 0, 8, "federate 8", _lf_message_length, serialized_message.get_rcl_serialized_message().buffer);
#line 30 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src-gen/federate__voxel_grid_downsampler/_networksender_0_0.cpp"
}
...
_networksender_0_0_self_t* new__networksender_0_0() {
    ...
    #endif // FEDERATED
    self->_lf__msg.tmplt.type.element_size = sizeof(std::shared_ptr<sensor_msgs::msg::PointCloud2>);
    return self;
}
