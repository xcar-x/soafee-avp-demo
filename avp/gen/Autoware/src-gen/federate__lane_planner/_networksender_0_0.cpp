...
#include "include/federate__lane_planner/NetworkSender_0_0.h"
...
void _networksender_0_0reaction_function_0(void* instance_args) {
    ...
    #line 124 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src/federate__lane_planner.lf"
    // Sending from msg[0] in federate federate__lane_planner to behavior_planner.lane_trajectory in federate federate__behavior_planner
    if (!msg[0]->is_present) {
    return;
    }
    ...
    lf_send_message(MSG_TYPE_P2P_MESSAGE, 1, 10, "federate 10", _lf_message_length, serialized_message.get_rcl_serialized_message().buffer);
#line 30 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src-gen/federate__lane_planner/_networksender_0_0.cpp"
}
