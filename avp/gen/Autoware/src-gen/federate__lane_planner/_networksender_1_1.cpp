...
#include "include/federate__lane_planner/NetworkSender_1_1.h"
...
void _networksender_1_1reaction_function_0(void* instance_args) {
    ...
    #line 141 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src/federate__lane_planner.lf"
    // Sending from msg[0] in federate federate__lane_planner to map_provider.request in federate federate__map_provider
    if (!msg[0]->is_present) {
    return;
    }
    ...
    lf_send_message(MSG_TYPE_P2P_MESSAGE, 4, 18, "federate 18", _lf_message_length, serialized_message.get_rcl_serialized_message().buffer);
#line 30 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src-gen/federate__lane_planner/_networksender_1_1.cpp"
}
