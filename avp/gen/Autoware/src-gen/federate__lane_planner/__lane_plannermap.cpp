...
#include "include/federate__lane_planner/_lane_plannermap.h"
#include "__lane_plannermap.h"
// ***** Start of method declarations.
// ***** End of method declarations.
__lane_plannermap_self_t* new___lane_plannermap() {
    __lane_plannermap_self_t* self = (__lane_plannermap_self_t*)lf_new_reactor(sizeof(__lane_plannermap_self_t));
