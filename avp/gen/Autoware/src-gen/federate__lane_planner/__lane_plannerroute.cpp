...
#include "include/federate__lane_planner/_lane_plannerroute.h"
#include "__lane_plannerroute.h"
// ***** Start of method declarations.
// ***** End of method declarations.
__lane_plannerroute_self_t* new___lane_plannerroute() {
    __lane_plannerroute_self_t* self = (__lane_plannerroute_self_t*)lf_new_reactor(sizeof(__lane_plannerroute_self_t));
