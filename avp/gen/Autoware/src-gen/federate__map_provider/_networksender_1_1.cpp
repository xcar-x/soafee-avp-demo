...
#include "include/federate__map_provider/NetworkSender_1_1.h"
...
void _networksender_1_1reaction_function_0(void* instance_args) {
    ...
    #line 279 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src/federate__map_provider.lf"
    // Sending from msg[4] in federate federate__map_provider to global_planner.map in federate federate__global_planner
    if (!msg[4]->is_present) {
    return;
    }
    ...
    _lf_serializer.serialize_message(msg[4]->value.get() , &serialized_message);
    size_t _lf_message_length = serialized_message.size();
    lf_send_message(MSG_TYPE_P2P_MESSAGE, 1, 13, "federate 13", _lf_message_length, serialized_message.get_rcl_serialized_message().buffer);
#line 30 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src-gen/federate__map_provider/_networksender_1_1.cpp"
}
