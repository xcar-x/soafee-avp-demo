...
interval_t _lf_action_delay_table[6];
lf_action_base_t* _lf_action_table[6];
size_t _lf_action_table_size = 6;
lf_action_base_t* _lf_zero_delay_cycle_action_table[0];
size_t _lf_zero_delay_cycle_action_table_size = 0;
reaction_t* network_input_reactions[6];
size_t num_network_input_reactions = 6;
...
void _lf_executable_preamble(environment_t* env) {
    ...
    lf_connect_to_federate(0);
    lf_connect_to_federate(10);
    lf_connect_to_federate(9);
...
void staa_initialization() {
    ...
    staa_lst[0]->STAA = 0;
    staa_lst[0]->num_actions = 6;
    staa_lst[0]->actions = (lf_action_base_t**) malloc(sizeof(lf_action_base_t*) * 6);
...
do { \
    ...
    _lf_action_table[0] = (lf_action_base_t*)&__map_provider_nr_federate__map_provider_self[0]->_lf_networkMessage; \
    __map_provider_nr_federate__map_provider_self[0]->_lf_networkMessage.source_id = 0; \
    _lf_action_delay_table[1] = NEVER; \
    _lf_action_table[1] = (lf_action_base_t*)&_ap_provider_nr_federate__map_provider_0_self[0]->_lf_networkMessage; \
    _ap_provider_nr_federate__map_provider_0_self[0]->_lf_networkMessage.source_id = 9; \
    _lf_action_delay_table[2] = NEVER; \
    _lf_action_table[2] = (lf_action_base_t*)&_ap_provider_nr_federate__map_provider_1_self[0]->_lf_networkMessage; \
    _ap_provider_nr_federate__map_provider_1_self[0]->_lf_networkMessage.source_id = 10; \
    _lf_action_delay_table[3] = NEVER; \
    _lf_action_table[3] = (lf_action_base_t*)&_ap_provider_nr_federate__map_provider_2_self[0]->_lf_networkMessage; \
    _ap_provider_nr_federate__map_provider_2_self[0]->_lf_networkMessage.source_id = 11; \
    _lf_action_delay_table[4] = NEVER; \
    _lf_action_table[4] = (lf_action_base_t*)&_ap_provider_nr_federate__map_provider_3_self[0]->_lf_networkMessage; \
    _ap_provider_nr_federate__map_provider_3_self[0]->_lf_networkMessage.source_id = 12; \
    _lf_action_delay_table[5] = NEVER; \
    _lf_action_table[5] = (lf_action_base_t*)&_ap_provider_nr_federate__map_provider_4_self[0]->_lf_networkMessage; \
    _ap_provider_nr_federate__map_provider_4_self[0]->_lf_networkMessage.source_id = 13; \
    staa_initialization(); \
} \
while (0)
/**
