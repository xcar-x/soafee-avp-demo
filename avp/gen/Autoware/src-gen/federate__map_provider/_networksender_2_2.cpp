...
#include "include/federate__map_provider/NetworkSender_2_2.h"
...
void _networksender_2_2reaction_function_0(void* instance_args) {
    ...
    #line 296 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src/federate__map_provider.lf"
    // Sending from msg[0] in federate federate__map_provider to lanelet2_visualizer.map in federate federate__lanelet2_visualizer
    if (!msg[0]->is_present) {
    return;
    }
    ...
    lf_send_message(MSG_TYPE_P2P_MESSAGE, 0, 0, "federate 0", _lf_message_length, serialized_message.get_rcl_serialized_message().buffer);
#line 30 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src-gen/federate__map_provider/_networksender_2_2.cpp"
}
