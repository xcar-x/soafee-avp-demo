...
#include "include/federate__mpc_controller/_mpc_controllertrajectory.h"
#include "__mpc_controllertrajectory.h"
// ***** Start of method declarations.
// ***** End of method declarations.
__mpc_controllertrajectory_self_t* new___mpc_controllertrajectory() {
    __mpc_controllertrajectory_self_t* self = (__mpc_controllertrajectory_self_t*)lf_new_reactor(sizeof(__mpc_controllertrajectory_self_t));
