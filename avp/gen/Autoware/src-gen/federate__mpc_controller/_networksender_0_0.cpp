...
#include "include/federate__mpc_controller/NetworkSender_0_0.h"
...
void _networksender_0_0reaction_function_0(void* instance_args) {
    ...
    #line 152 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src/federate__mpc_controller.lf"
    // Sending from msg[0] in federate federate__mpc_controller to lgsvl_interface.vehicle_command in federate federate__lgsvl_interface
    if (!msg[0]->is_present) {
    return;
    }
    ...
    lf_send_tagged_message(self->base.environment, 24000000, MSG_TYPE_P2P_TAGGED_MESSAGE, 1, 15, "federate 15", _lf_message_length, serialized_message.get_rcl_serialized_message().buffer);
#line 30 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src-gen/federate__mpc_controller/_networksender_0_0.cpp"
}
...
_networksender_0_0_self_t* new__networksender_0_0() {
    ...
    #endif // FEDERATED
    self->_lf__msg.tmplt.type.element_size = sizeof(std::shared_ptr<autoware_auto_msgs::msg::VehicleControlCommand>);
    return self;
}
