...
void _lf_executable_preamble(environment_t* env) {
    ...
    _fed.number_of_outbound_p2p_connections = 1;
...
do { \
    ...
    _lf_action_table[0] = (lf_action_base_t*)&__controller_nr_federate__mpc_controller_self[0]->_lf_networkMessage; \
    __controller_nr_federate__mpc_controller_self[0]->_lf_networkMessage.source_id = 10; \
    _lf_action_delay_table[1] = 16000000; \
    _lf_action_table[1] = (lf_action_base_t*)&_ontroller_nr_federate__mpc_controller_0_self[0]->_lf_networkMessage; \
    _ontroller_nr_federate__mpc_controller_0_self[0]->_lf_networkMessage.source_id = 15; \
    staa_initialization(); \
} \
while (0)
/**
