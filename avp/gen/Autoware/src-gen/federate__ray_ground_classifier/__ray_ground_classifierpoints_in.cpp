...
#include "include/federate__ray_ground_classifier/_ray_ground_classifierpoints_in.h"
...
__ray_ground_classifierpoints_in_self_t* new___ray_ground_classifierpoints_in() {
    __ray_ground_classifierpoints_in_self_t* self = (__ray_ground_classifierpoints_in_self_t*)lf_new_reactor(sizeof(__ray_ground_classifierpoints_in_self_t));
