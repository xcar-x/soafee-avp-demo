...
#include "include/federate__ray_ground_classifier/NetworkSender_0_0.h"
...
void _networksender_0_0reaction_function_0(void* instance_args) {
    ...
    #line 115 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src/federate__ray_ground_classifier.lf"
    // Sending from msg[0] in federate federate__ray_ground_classifier to euclidean_cluster_detector.points_in in federate federate__euclidean_cluster_detector
    if (!msg[0]->is_present) {
    return;
    }
    ...
    lf_send_tagged_message(self->base.environment, NEVER, MSG_TYPE_P2P_TAGGED_MESSAGE, 0, 6, "federate 6", _lf_message_length, serialized_message.get_rcl_serialized_message().buffer);
#line 30 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src-gen/federate__ray_ground_classifier/_networksender_0_0.cpp"
}
