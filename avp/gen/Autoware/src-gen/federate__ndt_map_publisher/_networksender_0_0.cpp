...
#include "include/federate__ndt_map_publisher/NetworkSender_0_0.h"
...
void _networksender_0_0reaction_function_0(void* instance_args) {
    ...
    #line 78 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src/federate__ndt_map_publisher.lf"
    // Sending from msg[0] in federate federate__ndt_map_publisher to p2d_ndt_localizer.ndt_map_points_in in federate federate__p2d_ndt_localizer
    if (!msg[0]->is_present) {
    return;
    }
    ...
    lf_send_tagged_message(self->base.environment, 250000000, MSG_TYPE_P2P_TAGGED_MESSAGE, 1, 8, "federate 8", _lf_message_length, serialized_message.get_rcl_serialized_message().buffer);
#line 30 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src-gen/federate__ndt_map_publisher/_networksender_0_0.cpp"
}
