...
#include "include/federate__behavior_planner/NetworkSender_2_2.h"
...
void _networksender_2_2reaction_function_0(void* instance_args) {
    ...
    #line 167 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src/federate__behavior_planner.lf"
    // Sending from msg[0] in federate federate__behavior_planner to lane_planner.route in federate federate__lane_planner
    if (!msg[0]->is_present) {
    return;
    }
    ...
    lf_send_tagged_message(self->base.environment, NEVER, MSG_TYPE_P2P_TAGGED_MESSAGE, 0, 12, "federate 12", _lf_message_length, serialized_message.get_rcl_serialized_message().buffer);
#line 30 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src-gen/federate__behavior_planner/_networksender_2_2.cpp"
}
