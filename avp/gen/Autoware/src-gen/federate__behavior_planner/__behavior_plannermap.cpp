...
#include "include/federate__behavior_planner/_behavior_plannermap.h"
#include "__behavior_plannermap.h"
// ***** Start of method declarations.
// ***** End of method declarations.
__behavior_plannermap_self_t* new___behavior_plannermap() {
    __behavior_plannermap_self_t* self = (__behavior_plannermap_self_t*)lf_new_reactor(sizeof(__behavior_plannermap_self_t));
