...
#include "include/federate__behavior_planner/_behavior_plannerlane_trajectory.h"
...
__behavior_plannerlane_trajectory_self_t* new___behavior_plannerlane_trajectory() {
    __behavior_plannerlane_trajectory_self_t* self = (__behavior_plannerlane_trajectory_self_t*)lf_new_reactor(sizeof(__behavior_plannerlane_trajectory_self_t));
