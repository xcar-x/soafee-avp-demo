...
#include "include/federate__behavior_planner/_behavior_plannerparking_trajectory.h"
...
__behavior_plannerparking_trajectory_self_t* new___behavior_plannerparking_trajectory() {
    __behavior_plannerparking_trajectory_self_t* self = (__behavior_plannerparking_trajectory_self_t*)lf_new_reactor(sizeof(__behavior_plannerparking_trajectory_self_t));
