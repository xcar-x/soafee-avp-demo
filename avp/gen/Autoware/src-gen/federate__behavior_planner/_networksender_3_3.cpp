...
#include "include/federate__behavior_planner/NetworkSender_3_3.h"
...
void _networksender_3_3reaction_function_0(void* instance_args) {
    ...
    #line 184 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src/federate__behavior_planner.lf"
    // Sending from msg[0] in federate federate__behavior_planner to parking_planner.route in federate federate__parking_planner
    if (!msg[0]->is_present) {
    return;
    }
    ...
    lf_send_tagged_message(self->base.environment, NEVER, MSG_TYPE_P2P_TAGGED_MESSAGE, 0, 11, "federate 11", _lf_message_length, serialized_message.get_rcl_serialized_message().buffer);
#line 30 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src-gen/federate__behavior_planner/_networksender_3_3.cpp"
}
...
_networksender_3_3_self_t* new__networksender_3_3() {
    ...
    #endif // FEDERATED
    self->_lf__msg.tmplt.type.element_size = sizeof(std::shared_ptr<autoware_auto_msgs::msg::Route>);
    return self;
}
