...
#include "include/federate__behavior_planner/NetworkSender_1_1.h"
...
void _networksender_1_1reaction_function_0(void* instance_args) {
    ...
    #line 150 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src/federate__behavior_planner.lf"
    // Sending from msg[0] in federate federate__behavior_planner to lgsvl_interface.state_command in federate federate__lgsvl_interface
    if (!msg[0]->is_present) {
    return;
    }
    ...
    lf_send_tagged_message(self->base.environment, 39000000, MSG_TYPE_P2P_TAGGED_MESSAGE, 0, 15, "federate 15", _lf_message_length, serialized_message.get_rcl_serialized_message().buffer);
#line 30 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src-gen/federate__behavior_planner/_networksender_1_1.cpp"
}
...
_networksender_1_1_self_t* new__networksender_1_1() {
    ...
    #endif // FEDERATED
    self->_lf__msg.tmplt.type.element_size = sizeof(std::shared_ptr<autoware_auto_msgs::msg::VehicleStateCommand>);
    return self;
}
