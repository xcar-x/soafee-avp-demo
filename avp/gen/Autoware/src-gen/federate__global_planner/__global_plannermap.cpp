...
#include "include/federate__global_planner/_global_plannermap.h"
#include "__global_plannermap.h"
// ***** Start of method declarations.
// ***** End of method declarations.
__global_plannermap_self_t* new___global_plannermap() {
    __global_plannermap_self_t* self = (__global_plannermap_self_t*)lf_new_reactor(sizeof(__global_plannermap_self_t));
