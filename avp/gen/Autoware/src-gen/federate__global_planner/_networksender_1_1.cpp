...
#include "include/federate__global_planner/NetworkSender_1_1.h"
...
void _networksender_1_1reaction_function_0(void* instance_args) {
    ...
    #line 108 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src/federate__global_planner.lf"
    // Sending from msg[0] in federate federate__global_planner to behavior_planner.global_path in federate federate__behavior_planner
    if (!msg[0]->is_present) {
    return;
    }
    ...
    lf_send_message(MSG_TYPE_P2P_MESSAGE, 2, 10, "federate 10", _lf_message_length, serialized_message.get_rcl_serialized_message().buffer);
#line 30 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src-gen/federate__global_planner/_networksender_1_1.cpp"
}
