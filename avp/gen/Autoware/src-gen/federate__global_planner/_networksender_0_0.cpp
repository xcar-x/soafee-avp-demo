...
#include "include/federate__global_planner/NetworkSender_0_0.h"
...
void _networksender_0_0reaction_function_0(void* instance_args) {
    ...
    #line 91 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src/federate__global_planner.lf"
    // Sending from msg[0] in federate federate__global_planner to map_provider.request in federate federate__map_provider
    if (!msg[0]->is_present) {
    return;
    }
    ...
    lf_send_message(MSG_TYPE_P2P_MESSAGE, 5, 18, "federate 18", _lf_message_length, serialized_message.get_rcl_serialized_message().buffer);
#line 30 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src-gen/federate__global_planner/_networksender_0_0.cpp"
}
