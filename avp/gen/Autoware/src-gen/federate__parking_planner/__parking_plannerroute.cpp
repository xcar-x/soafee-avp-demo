...
#include "include/federate__parking_planner/_parking_plannerroute.h"
#include "__parking_plannerroute.h"
// ***** Start of method declarations.
// ***** End of method declarations.
__parking_plannerroute_self_t* new___parking_plannerroute() {
    __parking_plannerroute_self_t* self = (__parking_plannerroute_self_t*)lf_new_reactor(sizeof(__parking_plannerroute_self_t));
