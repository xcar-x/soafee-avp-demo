...
#include "include/federate__parking_planner/_parking_plannermap.h"
#include "__parking_plannermap.h"
// ***** Start of method declarations.
// ***** End of method declarations.
__parking_plannermap_self_t* new___parking_plannermap() {
    __parking_plannermap_self_t* self = (__parking_plannermap_self_t*)lf_new_reactor(sizeof(__parking_plannermap_self_t));
