...
do { \
    ...
    _lf_action_table[0] = (lf_action_base_t*)&_ng_planner_nr_federate__parking_planner_self[0]->_lf_networkMessage; \
    _ng_planner_nr_federate__parking_planner_self[0]->_lf_networkMessage.source_id = 10; \
    _lf_action_delay_table[1] = NEVER; \
    _lf_action_table[1] = (lf_action_base_t*)&__planner_nr_federate__parking_planner_0_self[0]->_lf_networkMessage; \
    __planner_nr_federate__parking_planner_0_self[0]->_lf_networkMessage.source_id = 18; \
    staa_initialization(); \
} \
while (0)
/**
