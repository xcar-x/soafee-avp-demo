...
#include "include/federate__object_collision_estimator/NetworkSender_0_0.h"
...
void _networksender_0_0reaction_function_0(void* instance_args) {
    ...
    #line 149 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src/federate__object_collision_estimator.lf"
    // Sending from msg[0] in federate federate__object_collision_estimator to behavior_planner.modified_trajectory in federate federate__behavior_planner
    if (!msg[0]->is_present) {
    return;
    }
    ...
    lf_send_tagged_message(self->base.environment, 15000000, MSG_TYPE_P2P_TAGGED_MESSAGE, 3, 10, "federate 10", _lf_message_length, serialized_message.get_rcl_serialized_message().buffer);
#line 30 "/home/avp/soafee/soafee-avp-demo/avp/fed-gen/Autoware/src-gen/federate__object_collision_estimator/_networksender_0_0.cpp"
}
