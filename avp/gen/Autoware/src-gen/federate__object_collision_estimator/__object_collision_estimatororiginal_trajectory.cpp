...
#include "include/federate__object_collision_estimator/_object_collision_estimatororiginal_trajectory.h"
...
__object_collision_estimatororiginal_trajectory_self_t* new___object_collision_estimatororiginal_trajectory() {
    __object_collision_estimatororiginal_trajectory_self_t* self = (__object_collision_estimatororiginal_trajectory_self_t*)lf_new_reactor(sizeof(__object_collision_estimatororiginal_trajectory_self_t));
