...
#ifndef _FEDERATE__P2D_NDT_LOCALIZER_MAIN_H // necessary for arduino-cli, which automatically includes headers that are not used
...
#endif
typedef struct federate__p2d_ndt_localizer_self_t{
    self_base_t base; // This field is only to be used by the runtime, not the user.
    int end[0]; // placeholder; MSVC does not compile empty structs
} federate__p2d_ndt_localizer_self_t;
typedef struct {
    token_type_t type;
    lf_token_t* token;
    size_t length;
